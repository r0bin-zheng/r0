...
exp_folder_name, exp_path = common.create_exp_folder("ego_himmelblau_var2_epoch200", cur_dir+"/exps")
...
while nFE < alg_args["max_nFE"]:
    ...
    if x_new is not None:
        y_new = real_problem.evaluate(x_new)
...
exp_info = {
    ...
    "problem_surr_setting": problem_setting1,
