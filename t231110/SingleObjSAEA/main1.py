...
# 生成实验目录
exp_folder_name = common.create_exp_folder("test_visualization")
...
real_problem = p.get_problem(name=problem_name, setting=problem_setting, surrogate=None)
...
while nFE < alg_args["max_nFE"]:
    ...
    problem_predicted_by_surrogate = p.get_problem(problem_name, setting=problem_setting, surrogate=surrogate_model)
...
exp_data["problem_setting"] = problem_setting
...
visualization.plot_data_2d(X, problem_setting["xl"], problem_setting["xu"], exp_path)
visualization.plot_data_2d_1f(X, y, problem_setting["xl"], problem_setting["xu"], exp_path)
visualization.plot_gif(exp_data, n, problem_setting["xl"], problem_setting["xu"], exp_path)
