...
class MyProblem(Problem):
    def __init__(self, n_var=30, n_obj=1, n_constr=0, xl=-10, xu=10, surrogate1=None, surrogate2=None):
...
while nFE < max_nFE:
    ...
    # 定义问题
    problem = MyProblem(n_var=30, surrogate1=surrogate1, surrogate2=surrogate2)
