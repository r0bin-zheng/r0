...
class MyProblem(Problem):
    def __init__(self, n_var=100, n_obj=1, n_constr=0, xl=-10, xu=10, surrogate1=None, surrogate2=None):
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        if self.surrogate1 and self.surrogate2:
            ...
            out = np.column_stack([y_pred1, y_pred2, uncertainty])
            print(out.shape)
...
while nFE < max_nFE:
    ...
    # 定义问题
    problem = MyProblem(n_var=100, surrogate1=surrogate1, surrogate2=surrogate2)
